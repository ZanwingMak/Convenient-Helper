...
//百度网盘强制跳转到https协议
btnBaiduNetDiscUrlReplaceToHttps[0].onclick = function(){
    localStorage.baiduNetDiscUrlReplaceToHttps = 'on';
    addClass(btnBaiduNetDiscUrlReplaceToHttps[0],"on");
    removeClass(btnBaiduNetDiscUrlReplaceToHttps[1],"on");
};
btnBaiduNetDiscUrlReplaceToHttps[1].onclick = function(){
    localStorage.baiduNetDiscUrlReplaceToHttps = 'off';
    addClass(btnBaiduNetDiscUrlReplaceToHttps[1],"on");
    removeClass(btnBaiduNetDiscUrlReplaceToHttps[0],"on");
};
//百度网盘直接下载，坚决不安装管家
btnBaiduNetDiscDownloadDirectly[0].onclick = function(){
    localStorage.baiduNetDiscDownloadDirectly = 'on';
    addClass(btnBaiduNetDiscDownloadDirectly[0],"on");
    removeClass(btnBaiduNetDiscDownloadDirectly[1],"on");
};
btnBaiduNetDiscDownloadDirectly[1].onclick = function(){
    localStorage.baiduNetDiscDownloadDirectly = 'off';
    addClass(btnBaiduNetDiscDownloadDirectly[1],"on");
    removeClass(btnBaiduNetDiscDownloadDirectly[0],"on");
};
